...
${OBJECTDIR}/ContextManage.o: ContextManage.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContextManage.o ContextManage.c

${OBJECTDIR}/Dispatcher.o: Dispatcher.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dispatcher.o Dispatcher.c
...
${OBJECTDIR}/TCB.o: TCB.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCB.o TCB.c

${OBJECTDIR}/TCB_Queue.o: TCB_Queue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCB_Queue.o TCB_Queue.c

${OBJECTDIR}/TCB_list.o: TCB_list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCB_list.o TCB_list.c
...
${OBJECTDIR}/main_mypthreads.o: main_mypthreads.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_mypthreads.o main_mypthreads.c
